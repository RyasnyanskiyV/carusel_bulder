#target aftereffects
#targetengine "CleanCameraViewfinderHUDBuilderRVV1"

/*
    clean_camera_viewfinder_HUD_builder_RV v1
    Adobe After Effects 2022+

    Procedural clean camera viewfinder overlay.
...
(function CleanCameraViewfinderHUDBuilderRVV1() {
    var COMP_W = 3840;
    var COMP_H = 2160;
    var COMP_DURATION = 10;
    var FPS = 30;
    var COMP_BASE = "CLEAN_CAMERA_VIEWFINDER_MAIN";
    ...
    function drawCleanViewfinder(comp) {
        drawTopStatus(comp);
        drawCornerFrame(comp);
        drawCenterReticle(comp);
        drawLeftScale(comp);
        drawRightStatus(comp);
        drawAudioMeters(comp);
        drawLevelGauge(comp);
        drawBottomExposure(comp);
    }

    if (!app.project) app.newProject();
    app.beginUndoGroup("Clean Camera Viewfinder HUD Builder RV v1");
    try {
        ...
        alert("Clean Camera Viewfinder HUD Builder problems:\n\n- " + err.toString() + (err.line ? " line " + err.line : ""));
    } finally {
        app.endUndoGroup();
    }
})();

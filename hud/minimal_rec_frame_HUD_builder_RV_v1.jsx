#target aftereffects
#targetengine "MinimalRECFrameHUDBuilderRVV1"

/*
    minimal_rec_frame_HUD_builder_RV v1
    Adobe After Effects 2022+

    Procedural premium minimal REC frame overlay.
...
(function MinimalRECFrameHUDBuilderRVV1() {
    var COMP_W = 3840;
    var COMP_H = 2160;
    var COMP_DURATION = 10;
    var FPS = 30;
    var COMP_BASE = "MINIMAL_REC_FRAME_MAIN";
    ...
    app.beginUndoGroup("Minimal REC Frame HUD Builder RV v1");
    try {
        ...
        alert("Minimal REC Frame HUD Builder problems:\n\n- " + err.toString() + (err.line ? " line " + err.line : ""));
    } finally {
        app.endUndoGroup();
    }
})();

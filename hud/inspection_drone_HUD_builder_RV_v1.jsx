#target aftereffects
#targetengine "InspectionDroneHUDBuilderRVV1"

/*
    inspection_drone_HUD_builder_RV v1
    Adobe After Effects 2022+

    Procedural inspection drone HUD overlay.
...
(function InspectionDroneHUDBuilderRVV1() {
    var COMP_W = 3840;
    var COMP_H = 2160;
    var COMP_DURATION = 10;
    var FPS = 30;
    var COMP_BASE = "INSPECTION_DRONE_HUD_MAIN";
    ...
    function buildInspectionHUD(comp) {
        drawInspectionHeader(comp);
        drawInspectionLeftPanels(comp);
        drawInspectionCenter(comp);
        drawSignalExposure(comp);
        drawInspectionRightPanels(comp);
    }

    function buildHUD(comp) {
        buildInspectionHUD(comp);
    }
    ...
    app.beginUndoGroup("Inspection Drone HUD Builder RV v1");
    try {
        ...
        alert("Inspection Drone HUD Builder problems:\n\n- " + err.toString() + (err.line ? " line " + err.line : ""));
    } finally {
        app.endUndoGroup();
    }
})();
